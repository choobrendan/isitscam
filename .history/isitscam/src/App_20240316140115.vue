...
<div class="button-add">
  <button @click="showForm" type="button" class="fixed bottom-6  text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-4 text-center  items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
...
<script>
import ScamCard from 'C:\Users\Brendan\Downloads\isitscam\isitscam\src\components\ScamCard.vue';
export default {
  data() {
    return {
      isDragging: false,
