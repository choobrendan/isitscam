...
<div style="width: 100%;">
  ...
  <div class="mt-4 flex justify-between items-center">
    <div class="flex items-center">
      <!-- Upvote Button -->
      <button @click="upvote" type="button" class="border-none font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center">
        <svg class="w-4 h-4 hover:text-blue-500 text-blue-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
      ...
      <span>{{count}}</span>
      <!-- Downvote Button -->
      <button @click="downvote" type="button" class="border-none font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center">
        <svg class="w-5 h-5 hover:text-blue-500 text-blue-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="flex items-center">
      <!-- Comment Button -->
      <button type="button" class="border-none font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center">
      ...
      <!-- Share Button -->
      <button type="button" class="border-none font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center">
        <svg class="w-6 h-6 text-gray-800 hover:text-gray-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  ...
  methods: {
    ...
    handleChipClick(chip) {
      ...
      if (chip.text === "Whatsapp") {
        ...
        // You can replace the console.log statement with the action you want to execute
      }
    }
  }
};
