...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="./src/icons8-whatsapp-48.png">
</head>
<body>
    <div class="container">
        <div class="whatsapp">
            <div class="contacts">
                <div class="connav navs">
                    <div class="profile">
                        <img src="./src/109316527.jpg" alt="">
                    </div>
                    <div class="tools">
                        <div class="tool">
                            <img src="./src/icons8-people-64.png" alt="">
                        </div>
                        <div class="tool">
                            <img src="./src/icons8-loading-50.png" alt="">
                        </div>
                        <div class="tool">
                            <img src="./src/icons8-typing-96.png" alt="">
                        </div>
                        <div class="tool">
                            <img src="./src/icons8-menu-vertical-50.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="window blue">
                    <div class="winicon">
                        <img src="./src/icons8-notification-off-96.png" alt="">
                    </div>
                    <div class="wininfo">
                        <div>
                        ...
                        <div>
                            ...
                            <img src="./src/icons8-arrow-96.png" alt="">
                        </div>
                    </div>
                    <div class="winclose">
                        <img src="./src/icons8-close-90.png" alt="">
                    </div>
                </div>
                <div class="search">
                    <div class="searchBar">
                        <img src="./src/icons8-search-64.png" alt="">
                        <img src="./src/icons8-back-96.png" alt="">
                        <input type="text" name="" id="" placeholder="Rechercher ou démarrer une nouvelle discussion">
                    </div>
                    <img src="./src/icons8-grip-lines-96.png" alt="">
                </div>
                <div class="usersContainer">
                    <div class="users">
                        <div class="user">
                            <div class="pfp nopic">
                                <img src="./src/icons8-account-96.png" alt="">
                            </div>
                            <div class="userinfo">
                                <div class="name">
                                    <p>Raskolnikov</p>
                                ...
                                <div class="message">
                                    <div class="meicon">
                                        <div>
                                            <img src="./src/icons8-double-tick-96 (1).png " alt="">
                                        </div>
                                        ...
                                        <div class="arrow">
                                            <img src="./src/icons8-expand-arrow-96.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="user">
                            <div class="pfp">
                                <img src="./src/79feb1611dddcbce7910e0c1081df6e2.jpg" alt="">
                            </div>
                            <div class="userinfo">
                                <div class="name">
                                ...
                                <div class="message">
                                    <div class="meicon">
                                        <div>
                                            <img src="./src/icons8-missed-call-96.png" alt="">
                                        </div>
                        ...
                        <div class="user">
                            <div class="pfp">
                                <img src="./src/e5wnacz2aaaa.jpg" alt="">
                            </div>
                            <div class="userinfo">
                                <div class="name">
                                    <p>Meindert Titus</p>
                                ...
                                <div class="message">
                                    <div class="meicon">
                                        <div>
                                            <img src="./src/icons8-double-tick-96.png" alt="">
                                        </div>
                        ...
                        <div class="user selected">
                            <div class="pfp">
                                <img src="./src/tumblr_ovlq7qnBBR1uebi0uo1_1280.jpg" alt="">
                            </div>
                            <div class="userinfo">
                                <div class="name">
                                    <p>Ihsan</p>
                            ...
                            <div class="userinfo">
                                ...
                                <div class="message">
                                    <div class="meicon">
                                        ...
                                        <div class="righticon">
                                            <img src="./src/icons8-mute-52.png" alt="">
                                            <p>1</p>
                                        </div>
                                        <div class="arrow">
                                            <img src="./src/icons8-expand-arrow-96.png" alt="">
                        ...
                        <div class="user">
                            ...
                            <div class="userinfo">
                                ...
                                <div class="message">
                                    <div class="meicon">
                                        <div>
                                            <img src="./src/icons8-wall-clock-96.png" alt="">
                                            <img src="./src/icons8-video-call-100 (1).png" alt="">
                                        </div>
                                        <p>Vidéo</p>
                                        <div class="arrow">
                                            <img src="./src/icons8-expand-arrow-96.png" alt="">
            ...
            <div class="conversation">
                ...
                <div class="convemessages">
                    ...
                    <div class="middle">
                        <p><img src="./src/missed-video-call_118917.png" alt=""> Appel vocal manqué à 12:24 PM</p>
                    </div>
                        ...
                        <div class="sender mepop">
                            <div class="thereply">
                                ...
                                <div class="react rightr">
                                    <img src="./src/icons8-happy-96.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="sender mepop">
                    ...
                    <div class="receiverContainer arrowm">
                        <div class="reciver mepop">
                            <div class="thereply">
                                ...
                                <div class="emoji">
                                    <img src="./src/1000522-new-thinking-emoji-free-icon-hq.png" alt="">
                                </div>
                ...
                <div class="convebottom">
                    <div class="tools">
                        <div class="tool">
                            <img src="./src/icons8-smiling-90.png" alt="">
                        </div>
                        <div class="tool">
                            <img src="./src/icons8-attach-100.png" alt="">
                        </div>
                    </div>
                    <input type="text" placeholder="Taper un message">
                    <div class="tool">
                        <img src="./src/icons8-microphone-96.png" alt="">
                    </div>
                </div>
            </div>
        </div>
...
.convemessages {
    ...
    flex-direction: column;
    overflow: auto;
    background: url(./src/bg-chat-tile-dark_a4be512e7195b6b733d9110b408f075d.png) repeat rgba(239, 234, 226, 0.936);
}
