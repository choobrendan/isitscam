<template>
  ...
  <div class="flex flex-row">
    <div class="flex flex-row items-center justify-center">
      <!-- Click to Upload -->
      <div class="h-96 w-80 flex flex-row">
      <div v-if=showUpload class="flex items-center justify-center h-96">
           <label for="dropzone-file"
            class="flex flex-col items-center justify-center w-full h-96 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-200 dark:bg-gray-50 hover:bg-gray-100 dark:border-gray-200 dark:hover:border-gray-100 dark:hover:bg-gray-100">
...
<div  v-if="showPaste && !showPasteText"class="absolute top-1/2 w-full"><p disabled="disabled" >or <strong>copy</strong> an image and <br><strong>Crtl+V!</strong></p></div>
</div>
</div>
      <div >
