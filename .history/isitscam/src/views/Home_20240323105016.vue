...
<div  v-if="showPaste && !showPasteText"class="absolute top-1/4 w-full text-black"><p disabled="disabled" >or <strong>copy</strong> an image and <br><strong>Crtl+V!</strong></p></div>
</div>
</div>
      <div >
