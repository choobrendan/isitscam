...
<div  v-if="showPaste && !showPasteText"class="absolute top-20 w-full text-black"><p disabled="disabled" >or <strong>copy</strong> an image and <br><strong>Crtl+V!</strong></p></div>
  ...
  <div class="h-full  analysis  text-left" v-if="!showSubmit"> 
    ...
    <div class="flex flex-row ">
      <div class="w-1/2">
<ScamPercent :content="content1" ></ScamPercent>
<ScamPercent :content="content2"></ScamPercent>
<ScamPercent :content="content3"></ScamPercent>
<ScamPercent :content="content4" ></ScamPercent>
  </div><div class="w-1/2">
    <ScamPercent :content="content"></ScamPercent>
    <ScamPercent :content="content1"></ScamPercent>
    <ScamPercent :content="content1"></ScamPercent>
    <ScamPercent :content="content1"></ScamPercent>
</div>
