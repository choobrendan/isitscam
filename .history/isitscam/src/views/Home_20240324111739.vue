...
<p class="">  Open here for</p><p> more stuff!</p></div>
 ...
 <div class=" flex flex-col h-[800px] w-3/5 absolute top-0 left-0 right-0 bottom-0 ml-0 mr-0 justify-center items-center  z-20"  style="background-color: #eae6df;" v-if="emailClicked">
