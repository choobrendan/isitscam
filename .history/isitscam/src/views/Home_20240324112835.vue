...
<p class="">  Open here for</p><p> more stuff!</p></div>
 ...
 <div class="flex h-full w-full top-0 left-0 absolute justify-center align-center">
 <div class=" flex flex-col h-4/5 w-3/5 justify-center items-center  z-20"  style="background-color: #eae6df;" v-if="emailClicked">
