...
<p class="">  Open here for</p><p> more stuff!</p></div>
 ...
 <div class=" flex flex-col h-4/5 w-3/5 justify-center align-middle items-center translate-x-[14]  flex-wrap z-20"  style="background-color: #eae6df;" v-if="emailClicked">
