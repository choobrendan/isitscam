...
<p class="">  Open here for</p><p> more stuff!</p></div>
  ...
  <div class="button-add">
    ...
    <div class="flex flex-row h-[90%] w-[] justify-center align-middle items-center translate-y-[6%]  flex-wrap z-20 rounded-3xl"  style="background-color: #eae6df;" v-if="whatsappClicked">
