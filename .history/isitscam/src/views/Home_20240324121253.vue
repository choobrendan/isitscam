<template>
  ...
  <div class="flex flex-row">
    <div class="flex flex-row items-center justify-center">
      <!-- Click to Upload -->
      <div class="h-96 w-80 ">
      <div v-if=showUpload class="flex items-center justify-center  h-48 w-full">
           <label for="dropzone-file"
            class="flex flex-col items-center justify-center w-80 h-48 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-200 dark:bg-gray-50 hover:bg-gray-100 dark:border-gray-200 dark:hover:border-gray-100 dark:hover:bg-gray-100">
      ...
      <p v-if="!fileName" class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to
...
<div class="w-full relative h-48 w-full">
<div id="imageUpload" contenteditable="true" v-if="showPaste" @paste="handlePaste"></div>
<div  v-if="showPaste && !showPasteText"class="absolute top-20 w-full text-black"><p disabled="disabled" >or <strong>copy</strong> an image and <br><strong>Crtl+V!</strong></p></div>
</div>
</div>
      <div >
...
<p class="">  Open here for</p><p> more stuff!</p></div>
  ...
  <div class="drawer right" ref="drawer">
      ...
      <div class="grid grid-col justify-center align-middle m-12 gap-8">
        <scam-card v-for="i in 7" :key="i" @whatsappClicked="handleWhatsappClick" @emailClicked="handleEmailClick"/>
      </div>  
      <div class="wrap">
  ...
  <div class="button-add">
    ...
    <div class="h-full w-full top-0 left-0 absolute justify-center align-middle " v-if="whatsappClicked">
    <div class="flex flex-row h-[90%] w-[840px] justify-center align-middle items-center translate-y-[6%]  flex-wrap z-20 rounded-3xl"  style="background-color: #eae6df;" v-if="whatsappClicked">
      

    <whatsapp-game @whatsappClicked="handleWhatsappClick"/>
 </div>
 </div>
 <div class="h-full w-full absolute justify-center align-middle"  v-if="emailClicked">
