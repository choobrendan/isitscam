    ...
    <div class="flex flex-row items-center justify-center">
      ...
      <div v-if=showUpload class="flex items-center justify-center  h-48 w-full">
           <label for="dropzone-file"
            class="flex flex-col items-center justify-center w-80 h- border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-200 dark:bg-gray-50 hover:bg-gray-100 dark:border-gray-200 dark:hover:border-gray-100 dark:hover:bg-gray-100">
