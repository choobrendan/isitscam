          ...
          <div class="p-4 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-2 md:space-y-4" action="#">
              ...
              <a href="/home"
                ><button
                  type="submit"
                  class="w-full text-black bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                >
                  Sign in
                </button></a
              >
