...
<div>
  ...
  <div id="imageUpload" contenteditable="true" select-nonev-if="showPaste" @paste="handlePaste"><p>or <strong>copy</strong> an image and <strong>Crtl+V!</strong></p></div></div>
<div>
