...
<div>
  ...
  <div class="select-none" id="imageUpload" contenteditable="true" v-if="showPaste" @paste="handlePaste"><p>or <strong>copy</strong> an image and <strong>Crtl+V!</strong></p></div></div>
<div>
