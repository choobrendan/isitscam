...
<div>
  ...
  <div id="imageUpload" contenteditable="true" v-if="showPaste" @paste="handlePaste"><p class="select-none" >or <strong>copy</strong> an image and <strong>Crtl+V!</strong></p></div></div>
<div>
