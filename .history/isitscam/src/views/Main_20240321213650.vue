...
<div>
  ...
  <div class="w-full ">
  <div id="imageUpload" contenteditable="true" v-if="showPaste" @paste="handlePaste"></div>  <div class="h- absolute"><div><p disabled="disabled" >or <strong>copy</strong> an image and <strong>Crtl+V!</strong></p></div></div></div>
