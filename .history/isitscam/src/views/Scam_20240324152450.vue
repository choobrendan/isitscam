...
<div class="">
<div>
    <img src="../assets/OBJECTS.png" class="">
 <p class="text-black">This could have been a scam... <br>but luckily, we chose not to!</p>   
<p class="text-black">Scammers are getting more and more creative</p>
<p class="text-black">You should be as well!</p>
<p class="text-black">Click here to know more</p>
</div>
</div>
  </template>
