<template>
    <Transition>
    <div class="scam-bg absolute top-0 w-full h-full flex flex-col self-center" v-if="!hideScam">
...
<div>
 <p class="text-black text-[36px] font-bold">This could have been a scam... </p><p class="text-black text-3xl font-bold">but luckily for you, we chose not to!</p>   
<p class="text-black text-lg pt-4">Scammers are getting more and more creative</p>
<p class="text-black text-lg pt-4">You should be as well!</p>
<a href="/">
<button type="button"
              class=" w-full my-4 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Click here to know more</button></a>
</div>
</div>
</div>
  </template>
