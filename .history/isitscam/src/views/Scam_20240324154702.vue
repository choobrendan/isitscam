...
<div>
 <p class="text-black text-[36px] font-bold">This could have been a <span class="text-red">scam...</span> </p><p class="text-black text-3xl font-bold">but luckily for you, we chose not to!</p>   
