    ...
    <div class="grid grid-col lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4 mt-4">
      <div class="grid gap-4">
        <scam-card v-for="(item, index) in scamData" :key="index" :count="item.count" :title="item.title"
          ...
          @whatsappClicked="handleWhatsappClicked" @emailClicked=" handleEmailClick" />
      </div>
    </div>
    <div class="wrap">
      <div class="drag" ref="drag">
        <svg viewBox="0 0 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" transform="rotate(90)" stroke="#000000"
          stroke-width="0.034">
