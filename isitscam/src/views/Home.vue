<template>
      ...
      <div class="flex flex-row items-center justify-center">
        ...
        <div class="flex items-center justify-center w-full">
          <label for="dropzone-file"
            class="flex flex-col items-center justify-center w-80 h-96 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-200 dark:bg-gray-50 hover:bg-gray-100 dark:border-gray-200 dark:hover:border-gray-100 dark:hover:bg-gray-100">
  ...
  <div class="drawer right" ref="drawer">
    ...
    <p class="mx-12 mt-10 font-lg">Discover Scams</p>
    <!-- TODO: the cards are not showing up -->
    <div class="grid grid-col lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4 m-12 mt-4">
