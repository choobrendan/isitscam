    ...
    <div class="flex flex-row">
      <div class="flex flex-row items-center justify-center">
        ...
        <div class="h-96 w-80">
          <div
            v-if="showUpload"
            class="flex items-center justify-center h-48 w-full"
          >
            <label
              for="dropzone-file"
          ...
          <div class="w-full relative h-48 w-full">
            ...
            ></div>
            <div
              v-if="showPaste && !showPasteText"
              class="absolute top-20 w-full text-black"
            >
              <p disabled="disabled">
                or <strong>copy</strong> an image and <br /><strong
                  >Crtl+V!</strong
                >
              </p>
            </div>
