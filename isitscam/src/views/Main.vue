        ...
        <div class="flex flex-row w-96 ">
          <div v-if=showUpload class="flex items-center justify-center w-full">
            <label for="dropzone-file"
              ...
              <div class="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p v-if="!fileName" class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                    class="font-semibold">Click to
                    upload</span> or drag and drop</p>
                <p v-if="fileName" class="text-xs text-gray-500 dark:text-gray-400">{{ fileName }}</p>
                <p v-if="!fileName" class="text-xs text-gray-500 dark:text-gray-400">SVG, PNG, JPG or GIF (MAX.
                  800x400px)</p>
              </div>
          ...
          <div class="w-full relative">
            ...
            <div v-if="showPaste && !showPasteText" class="absolute top-1/2 w-full">
              <p disabled="disabled">or <strong>copy</strong> an image and <br><strong>Crtl+V!</strong></p>
            </div>
          </div>
