<template>
  ...
  <!-- TODO: fix appear on hover -->
  <div data-dial-init class="fixed end-6 bottom-6 ">
    <div id="speed-dial-menu-default" class="group group-hover:flex flex-col items-center hidden mb-4 space-y-2">
...
export default {
  ...
  data: () => {
    return {
      typeValue: "",
      typeStatus: false,
      displayTextArray: ["Phishing Scams", "Identity Theft", "Investment Scams", "Romance Scams", "Employment Scams", "Prize Scams"],
      typingSpeed: 120,
      erasingSpeed: 40,
      newTextDelay: 2800,
